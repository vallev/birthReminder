...
if ($object->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('birthreminder_core_path', null, $modx->getOption('core_path') . 'components/birthreminder/') . 'model/';
            $modx->addPackage('birthreminder', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = MODX_CORE_PATH . 'components/birthreminder/model/schema/birthreminder.mysql.schema.xml';
